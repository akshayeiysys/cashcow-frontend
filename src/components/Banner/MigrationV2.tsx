...
import { Text, Flex, Box, ErrorIcon, Button } from 'cashcow-ui'
    ...
    >
      <Box ml="48px">
        <Text color="warning" bold>
          You must complete migration if you want to keep earning from any Cashcow Defi LP tokens and Cashcow Defi farms.
        </Text>
