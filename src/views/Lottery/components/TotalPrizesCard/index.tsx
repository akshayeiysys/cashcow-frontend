...
import { Heading, Card, CardBody, CardFooter, Text, PancakeRoundIcon, Flex, Skeleton } from 'cashcow-ui'
          ...
          <Flex mb="16px" alignItems="center" justifyContent="space-between" style={{ height: '20px' }}>
            ...
            {currentLotteryNumber > 0 && (
              <Text fontSize="12px" style={{ fontWeight: 600 }}>
                {t(`Round #`)} {t(`${currentLotteryNumber}`, { num: currentLotteryNumber })}
              </Text>
            )}
          </Flex>
        )}
        <CardHeading>
          <Left>
            ...
            <PrizeCountWrapper>
              ...
              <Heading size="lg">{lotteryPrizeWithCommaSeparators} COW</Heading>
