...
import { ButtonMenu, ButtonMenuItem, Toggle, Text, Flex, NotificationDot } from 'cashcow-ui'
  ...
  return (
    <Flex alignItems="center" justifyContent="center" mb="32px">
      <ButtonMenu activeIndex={isExact ? 0 : 1} scale="sm" >
        <ButtonMenuItem className="sizeEarning" as={Link} to={`${url}`}>
          {t('Live')}
        </ButtonMenuItem>
        <NotificationDot show={hasStakeInFinishedPools}>
          <ButtonMenuItem className="sizeEarning" as={Link} to={`${url}/history`}>
            {t('Finished')}
          </ButtonMenuItem>
        </NotificationDot>
      </ButtonMenu>
      <Flex ml="24px" justifyContent="center" alignItems="center">
        ...
        <Text ml="8px" className="sizeEarning">
          {t('Staked only')}
        </Text>
      </Flex>
    </Flex>
